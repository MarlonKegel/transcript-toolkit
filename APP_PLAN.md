...
| 6 | Icon | generated by `scripts/make_app_icon.py` (committed, reproducible). Placeholder-grade — swap freely, it is one script and one PNG |
...
| 12 | LICENSE | **still open — Phase E blocker** |
