...
1. **Workspace** — make a project (a folder holding one collection of transcripts and
   ...
   them. Read the speaker-role table it prints: if an interviewer appears as a narrator, fix
   `interviewer_labels` in the settings file and import again.
...
- *"No demo sample drawn yet"* — the demo needs a handful of interviews chosen to run on.
